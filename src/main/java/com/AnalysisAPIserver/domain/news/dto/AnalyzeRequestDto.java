...
import lombok.Setter; // ⭐️ Setter import 추가
...
@Getter
@Setter // ⭐️ Setter 추가
public class AnalyzeRequestDto<T> { // ⭐️ final 제거
    ...
    @Getter
    @Setter // ⭐️ Setter 추가
    public static class Header { // ⭐️ final 제거
    ...
    @Getter
    @Setter // ⭐️ Setter 추가
    public static class Body<T> { // ⭐️ final 제거
