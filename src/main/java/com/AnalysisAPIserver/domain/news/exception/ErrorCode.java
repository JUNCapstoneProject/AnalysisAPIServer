package com.AnalysisAPIserver.domain.news.exception;
...
public enum ErrorCode {
    ...
    INVALID_REQUEST(HttpStatus.BAD_REQUEST,
            "요청 형식이 올바르지 않습니다. 요청 파라미터를 확인하세요."),

    /**
     * API 키가 유효하지 않거나 만료되었을 경우 발생합니다. (401 Unauthorized)
     */
    UNAUTHORIZED_API_KEY(HttpStatus.UNAUTHORIZED,
            "API 키가 유효하지 않거나 만료되었습니다. API 키를 확인하세요."),
    ...
    TOO_MANY_REQUESTS(HttpStatus.TOO_MANY_REQUESTS,
            "일일 요청 한도를 초과했습니다. 내일 다시 시도하거나 요금제를 업그레이드하세요."),

    /**
     * 서버 내부에서 예상치 못한 오류가 발생했을 경우입니다. (500 Internal Server Error)
     */
    SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,
            "서버 오류가 발생했습니다. 잠시 후 다시 시도하거나 지원팀에 문의하세요.");
